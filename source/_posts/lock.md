...
> 内存相关的知识非常重要，需要很大篇幅和示例图来阐述。另一篇文章[内存分段与分页](https://www.yigegongjiang.com/2022/memory/)对 CPU 和内存的数据读取做了详细阐述。在[内存分段与分页](https://www.yigegongjiang.com/2022/memory/)中文字数超过了 1W，本文的文字数也超过了 4W，均需要多张配图。重要性和难理解程度，都很高。
...
<img src="https://cdn.jsdelivr.net/gh/yigegongjiang/image_space@main/blog_img/202308061930789.png" width="50%">
